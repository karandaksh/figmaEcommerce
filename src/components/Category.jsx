...
const Category = ({ CategoryImg, CategoryName, CategoryLink, CategoryId }) => {
    ...
    return (
        <>
            <div className="category cursor-pointer border rounded text-center mr-6 hover:bg-(--redColor) duration-300 ease-in-out hover:border-white hover:text-white" onClick={categoryClick} id={CategoryId} >
