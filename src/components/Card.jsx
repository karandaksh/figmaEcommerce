...
const Card = () => {
    return (
        <div className="cardParent mr-10 mb-5">
            ...
            <div className="cardImg bg-gray-100 py-14 relative overflow-hidden tran ">
            ...
            <div className="cardDetails px-3">
                ...
                <div className="flex items-center">
                    ...
                    <p className="text-gray-600 font-semibold my-2 line-through ml-3.5">$ 299</p>
                </div>
