            ...
            <div className="bg-black text-white p-8 ">
                <div className='grid grid-cols-7 gap-4 bg-black text-white'>
                    <div className="col-span-3 px-16 pt-3 pb-3.5">
                        ...
                        <h1 className='text-5xl tracking-wider leading-14 font-semibold'>{props.productHeading}</h1>
                        <Link to={props.productLink} target="_blank" className='mt-8 block underline underline-offset-8'>
                            Shop Now <i className="fa-solid fa-arrow-right pl-2"></i>
                        </Link>
                    </div>
                    <div className="col-span-3 col-start-5">
                        <img src={props.productPhoto} className='ml-auto w-11/12 scale-125 overflow-hidden bottom-0' alt="" />
                    </div>
                </div>
            </div>
        </>
