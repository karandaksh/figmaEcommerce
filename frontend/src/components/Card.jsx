...
const Card = ({ id, cardDiscountPercentage, cardIMg, cardTitle, cardOriginalPrice, cardPrice, cardReview, onAddToCart, onCardClick }) => {
    ...
    return (
        <div className="cardParent mr-10 mb-5 dark:border dark:rounded-lg" id={id} onClick={handleOnCardClick}>
            ...
            {/* <div className="cardImg bg-gray-100 relative overflow-hidden tran  dark:rounded-t-2xl "> */}
            <div className="cardImg bg-gray-100 dark:bg-zinc-700 border-b relative overflow-hidden dark:rounded-t-lg ">
                ...
                <button className='favoriteProduct' onClick={(e) => { e.stopPropagation(); AddToFav(id); }}>
                    ...
                    <i
                        className={`absolute right-3 top-3 p-2 bg-white dark:bg-transparent rounded-full
            ...
            <div className="cardDetails px-3">
                ...
                <div className="flex items-center">
                    <p className="text-(--redColor) dark:text-white font-semibold my-2">$ {cardPrice}</p>
                    <p className="text-gray-600 dark:text-(--redColor) font-semibold my-2 line-through ml-3.5">$ {cardOriginalPrice || cardPrice}</p>
                </div>
